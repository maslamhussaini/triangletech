...
export function ContactCTA() {
  return <section className="contact-cta"><div className="container cta-inner"><div><span className="eyebrow light">SEE TRIANGLETECH IN ACTION</span><h2>Book a personalized<br />product walkthrough.</h2></div><div><RouteLink className="button button-accent" href="/contact">Book a Free Demo<Icon name="arrow" /></RouteLink><RouteLink className="cta-phone" href="/contact">Contact TriangleTech</RouteLink></div></div></section>;
}
